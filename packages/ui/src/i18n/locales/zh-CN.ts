...
const zhCN: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "你希望 ZAICODE 如何呈现工作过程？",
  ...
  "occupationOnboarding.description": "选择最接近你日常工作的一项，让 ZAICODE 更懂你的工作。",
  ...
  "occupationOnboarding.memoryDescription": "让 ZAICODE 记住你的偏好与工作上下文。",
  ...
  "startup.global.silent": "正在启动 ZAICODE",
  ...
  "startup.global.servicesFailed":
    "本地数据准备已完成，但应用服务启动失败。请复制诊断信息，退出并重新打开 ZAICODE。",
  ...
  "startup.global.starting_services": "正在启动 ZAICODE",
  "startup.global.ready": "本地数据已就绪",
  "startup.global.failed": "无法完成启动准备",
  "startup.global.help":
    "准备完成后将自动进入 ZAICODE。历史记录较多时可能需要较长时间，请保持应用运行。",
  ...
  "settings.computerUse.disabledToast": "电脑控制已关闭，已有对话需重启 ZAICODE 后生效。",
  ...
  "conversationShare.permission.linkEditorHint": "可导入到 ZAICODE",
  ...
  "conversationShare.import.loginRequired": "该分享暂不支持匿名导入，请登录 ZAICODE 后重试",
  ...
  "login.title": "欢迎来到 ZAICODE",
  "login.description": "连接账号，开始使用 ZAICODE",
  ...
  "app.login": "连接使用",
  "app.logout": "断开连接",
  "logout.confirm.title": "断开连接并重启 ZAICODE？",
  ...
  "modelTrajectory.empty": "暂无模型调用记录（仅 ZAICODE Agent 会落盘 model-io）",
  ...
  "titleBar.menu.help.about": "关于 ZAICODE",
  ...
  "titleBar.menu.help.toggleZAICODEStdioTap": "抓取 Agent stdio 通信",
  ...
  "forceUpdate.title": "需要升级 ZAICODE 后继续使用",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "工作区目录不存在或无法访问，当前仅可查看历史记录。恢复该目录后重启 ZAICODE 即可继续使用。",
  ...
  "ssh.assetInstallModeDescription":
    "远端服务器下载可减少上传等待，但服务器需要能访问 ZAICODE CDN，并具备下载、解压和校验工具。",
  "ssh.password": "密码",
  ...
  "settings.terminalFontFamilyDescription":
    "留空时自动探测系统终端配置；填写后作为 ZAICODE 终端的字体覆盖。",
  ...
  "settings.zaicodeSound.search": "FastPrompter 音效（{count}）— 按名称搜索",
  "settings.zaicodeSound.choose": "选中的通知音效",
  "settings.zaicodeSound.default": "ZAICODE 默认",
  "settings.zaicodeSound.custom": "我的音效",
  "settings.zaicodeSound.import": "导入我的音效…",
  "settings.zaicodeSound.preview": "试听",
  "settings.zaicodeSound.imported": "音效已导入并选中。",
  "settings.zaicodeSound.playing": "正在试听。",
  "settings.zaicodeSound.failed": "无法播放此音效。",
  "zaicode.settings.autoSessionTitle": "实时 SAIPEN 会话标题",
  "zaicode.settings.autoSessionTitleHint": "按最新的 NEXT EXACT ACTION 命名当前会话。默认开启。",
  "zaicode.settings.listLabelWidth": "项目与会话色条：{width}px",
  ...
  "settings.zcodeInteractionBehaviorDescription":
    "在 ZAICODE 运行时将后续操作加入队列，或引导至下一轮工具调用后运行。",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "不能选择 ZAICODE 安装目录作为数据存储路径。请选择安装目录之外的文件夹。",
  ...
  "settings.migration.sectionDescription":
    "扫描本机 Claude Code 原生历史，可按 workspace 和时间范围筛选，再把选中的会话导入到对应的 ZAICODE 任务列表。",
  ...
  "resourceManager.storage.summaryTotal": "ZAICODE 总占用",
  ...
  "resourceManager.storage.diskUsage": "ZAICODE 占用 {used}",
  ...
  "settings.browser.desktopOnly": "浏览器数据只能在 ZAICODE 桌面端管理。",
  ...
  "settings.browser.import.helperVerificationFailed":
    "ZAICODE 的 Windows 安全导入组件校验失败，Cookie 未导入。请重新安装或更新 ZAICODE。",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome 在 Windows 上使用 App-Bound 加密保护 Cookie。ZAICODE 将为本次导入请求管理员权限，临时启动系统服务，完成后立即删除。不会读取或导入 Chrome 密码。",
  ...
  "settings.mcp.description": "管理 ZAICODE Agent 使用的 MCP 服务器配置。",
  ...
  "settings.mcp.host.activeDescription":
    "该 MCP 服务器由 ZAICODE 宿主为 {pluginName} 插件提供，运行时身份由宿主管理。",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "当前 ZAICODE Agent 不支持 OAuth 状态刷新。请升级或重启 ZAICODE，然后重新打开 MCP 设置进行完整刷新。",
  ...
  "settings.mcp.failure.not_authenticated": "当前未登录，请先登录 ZAICODE。",
  ...
  "settings.mcpServers.import.importing": "正在导入 MCP 服务器到 ZAICODE",
  ...
  "settings.modelProvider.startPlan.highlight.trial.description": "登录 ZAICODE 3.x 后开始计时。",
  ...
  "settings.modelProvider.startPlan.compatibility":
    "支持 BYOK、BYOA；Base URL、API Format 和 API Key 由 ZAICODE 自动维护，无需手动配置。",
  ...
  "settings.modelProvider.codingPlan.purchase.teamMemberNoticeDescription":
    "请先在 BigModel 团队套餐管理页添加自己或其他成员，完成后即可在 ZAICODE 使用团队额度。",
  ...
  "settings.modelProvider.help.contextWindow":
    "模型一次可处理的上下文容量，单位为 Token。ZAICODE 会据此管理上下文。\n请勿超过模型的实际上限。",
  ...
  "settings.modelProvider.help.followRecommendedConfig":
    "根据模型 ID、Base URL 和 API 格式，为您智能匹配推荐配置。ZAICODE 会持续更新推荐配置，并自动同步给您。\n如果手动修改某项配置，该项将转为手动管理，不再跟随推荐更新；其他配置仍由智能配置管理。",
  ...
  "settings.usage.billingBanner.description":
    "连接 {provider} 账号后查询编程套餐权益，购买或配置后回到 ZAICODE 即可继续编码。",
  ...
  "sidebar.usage.plan.zcodeMcpDescription": "ZAICODE 预置插件 MCP 每日合计额度",
  ...
  "settings.skills.import.mode.copy.description":
    "将完整技能目录复制到 ZAICODE。外部 Agent 目录后续变更不会自动同步。",
  "settings.skills.import.mode.symlink.description":
    "创建指向外部 Agent 技能目录的链接。ZAICODE 会跟随来源目录后续变更，但该技能依赖来源路径持续可用。",
  "settings.skills.import.importing": "正在导入技能到 ZAICODE",
  ...
  "zaicode.todo.dock": "固定待办窗口",
  "zaicode.todo.close": "关闭待办窗口",
  "zaicode.font.title": "字体与排版",
  "zaicode.font.description": "选择字体与间距。修改即时生效，并在重启后保留。",
  "zaicode.font.reset": "重置字体",
  "zaicode.font.codeFamily": "代码字体",
  "zaicode.font.uiFamily": "界面字体",
  "zaicode.font.customCode": "已安装的代码字体名称",
  "zaicode.font.customUi": "已安装的界面字体名称",
  "zaicode.font.codeSize": "代码字号",
  "zaicode.font.inlineSize": "行内代码字号",
  "zaicode.font.lineHeight": "代码行距",
  "zaicode.font.uiSize": "界面字号",
  "zaicode.font.wrap": "长代码行换行",
  "zaicode.font.numbers": "显示行号",
  "zaicode.font.ligatures": "字体连字",
  "zaicode.font.preview": "实时预览",
  "zaicode.font.installedHint": "Terminus 已随应用提供。其他字体须在本机安装。",
  "zaicode.nav.open": "ZAICODE",
  "zaicode.title": "ZAICODE",
  "zaicode.inspector.openSession": "打开会话",
  "zaicode.queue.title": "任务",
  "zaicode.queue.filter.all": "全部",
  "zaicode.queue.filter.active": "进行中",
  "zaicode.queue.filter.attention": "需要处理",
  "zaicode.queue.filter.done": "已结束",
  "zaicode.queue.filterHelp.all": "本项目的全部任务",
  "zaicode.queue.filterHelp.active": "排队中或正在运行",
  "zaicode.queue.filterHelp.attention": "失败或阻塞：重试或修复后恢复",
  "zaicode.queue.filterHelp.done": "已完成或已取消",
  "zaicode.queue.needAgent": "请先创建或启用一个 Agent",
  "zaicode.queue.instructionsPlaceholder": "要做什么？留空即一键执行：/goal cc all（完成 SAIPEN 看板）。（Ctrl+Enter 添加任务）",
  "zaicode.queue.delegateHelp": "该协调者完成后，结果会作为后续任务交给所选 Agent。",
  "zaicode.queue.more": "标题与优先级（可选）",
  "zaicode.queue.titlePlaceholder": "简短标题（默认取正文第一行）",
  "zaicode.queue.priorityHelp": "数值越大越先运行，0 为普通。",
  "zaicode.queue.willAutoStart": "自动驾驶已开启：有空闲并行位时任务立即开始。",
  "zaicode.queue.willWait": "自动驾驶已关闭：任务会等待你点击运行。",
  "zaicode.queue.emptyNoAgents": "从这里开始：先创建 Agent（谁来做），再为它添加任务。",
  "zaicode.queue.emptyAll": "还没有任务。添加一个：描述工作并选择 Agent。",
  "zaicode.queue.emptyFiltered": "该分组暂无任务。",
  "zaicode.action.newTask": "新任务",
  "zaicode.action.addTask": "添加任务",
  "zaicode.action.createFirstAgent": "创建 Agent",
  "zaicode.action.duplicate": "复制",
  "zaicode.action.startWaiting": "运行 {count} 个等待任务",
  "zaicode.primary.run": "运行",
  "zaicode.primary.stop": "停止",
  "zaicode.primary.retry": "重试",
  "zaicode.primary.resume": "恢复",
  "zaicode.primaryHelp.run": "立即开始该任务（不按排队顺序）",
  "zaicode.primaryHelp.stop": "停止运行中的会话并取消任务",
  "zaicode.primaryHelp.retry": "重新排队该任务的新副本",
  "zaicode.primaryHelp.resume": "把阻塞的任务放回队列",
  "zaicode.statusHelp.draft": "草稿：已保存，尚未排队。",
  "zaicode.statusHelp.queued": "排队中：等待空闲并行位。",
  "zaicode.statusHelp.ready": "就绪：下一个开始。",
  "zaicode.statusHelp.running": "运行中：Agent 会话正在处理。",
  "zaicode.statusHelp.waiting": "等待中：会话在等你的回复或授权。",
  "zaicode.statusHelp.blocked": "阻塞：Agent 被禁用/缺失，或运行中应用重启。修复后恢复。",
  "zaicode.statusHelp.completed": "已完成：结果见详情。",
  "zaicode.statusHelp.failed": "失败：运行出错，查看详情后重试。",
  "zaicode.statusHelp.cancelled": "已取消：由你停止。",
  "zaicode.flow.agents": "Agent",
  "zaicode.flow.agentsHelp": "谁来做：带指令和模型池的可复用执行者",
  "zaicode.flow.agentsCount": "{total}（{enabled} 启用）",
  "zaicode.flow.queue": "任务",
  "zaicode.flow.queueHelp": "做什么：任务排队，并按并行上限运行",
  "zaicode.flow.queueCount": "{waiting} 等待 · {running} 运行",
  "zaicode.flow.results": "结果",
  "zaicode.flow.resultsHelp": "结果如何：点击任务查看结果和会话",
  "zaicode.flow.resultsCount": "{done} 完成",
  "zaicode.flow.attention": " · {attention} 需要处理",
  "zaicode.flow.autoOn": "自动驾驶：新任务自动开始",
  "zaicode.flow.autoOff": "自动驾驶关闭：手动开始任务",
  "zaicode.flow.autoOffWaiting": "自动驾驶关闭：任务等待运行",
  "zaicode.autopilot.on": "自动驾驶：开",
  "zaicode.autopilot.off": "自动驾驶：关",
  "zaicode.autopilot.help": "开：添加任务或有空位时立即开始。关：任务等待你点击运行。",
  "zaicode.unavailable": "当前主机不提供 ZAICODE 服务。",
  "zaicode.roster.title": "代理",
  "zaicode.roster.modes": "选择模式创建代理，再选模型池并保存",
  "zaicode.roster.empty": "还没有 Agent。Agent 是可复用的执行者：名称 + 指令 + 模型池。",
  "zaicode.roster.diagnostics": "{count} 条持久化代理定义需要修复。",
  "zaicode.roster.queueDepth": "队列 {count}",
  "zaicode.queue.filterAll": "全部",
  "zaicode.queue.empty": "还没有任务。",
  "zaicode.queue.diagnostics": "{count} 条持久化任务需要修复。",
  "zaicode.queue.attempt": "第 {count} 次尝试",
  "zaicode.queue.concurrency": "并行 {running}/{limit}",
  "zaicode.editor.title": "代理",
  "zaicode.editor.createTitle": "新建代理",
  "zaicode.editor.editTitle": "编辑代理",
  "zaicode.field.name": "名称",
  "zaicode.field.role": "角色",
  ...
  "zaicode.route.unresolved": "route-unresolved — 没有可执行路由",
  "zaicode.field.planOnly": "只读（plan）权限（默认：yolo 完全访问）",
  "zaicode.field.enabled": "启用",
  "zaicode.field.assignAgent": "代理",
  "zaicode.field.title": "任务标题",
  "zaicode.field.priority": "优先级",
  "zaicode.field.delegateTo": "委托给",
  "zaicode.field.permissionMode": "权限模式",
  "zaicode.action.create": "创建",
  "zaicode.action.save": "保存",
  "zaicode.action.cancel": "取消",
  "zaicode.action.edit": "编辑",
  "zaicode.action.enable": "启用",
  "zaicode.action.disable": "停用",
  "zaicode.action.queue": "加入队列",
  "zaicode.action.dispatch": "派发",
  "zaicode.action.dispatchQueue": "派发队列",
  "zaicode.action.dispatchQueue.help": "按并发上限启动符合条件的 Ready 任务。",
  "zaicode.queue.concurrencyHelp": "运行中任务 / 并发上限。达到上限后，需等有空位才会启动新任务。",
  "zaicode.action.cancelJob": "取消任务",
  "zaicode.action.retry": "重试",
  "zaicode.action.resume": "恢复",
  "zaicode.action.remove": "删除",
  "zaicode.action.moveUp": "上移",
  "zaicode.action.moveDown": "下移",
  "zaicode.action.refresh": "刷新",
  "zaicode.action.concurrencyUp": "提高并发",
  "zaicode.action.concurrencyDown": "降低并发",
  "zaicode.inspector.title": "检查器",
  "zaicode.inspector.empty": "选择左侧 Agent 查看配置，或选择中间任务查看状态、结果和会话。",
  "zaicode.inspector.started": "开始时间",
  "zaicode.inspector.finished": "结束时间",
  "zaicode.inspector.session": "会话",
  "zaicode.inspector.configuredBackend": "配置的后端",
  "zaicode.inspector.routeStatus": "路由状态",
  "zaicode.inspector.resolvedSelection": "传给运行时的已解析 Provider/模型",
  "zaicode.inspector.configuredSection": "已配置",
  "zaicode.inspector.resolvedSection": "已解析",
  "zaicode.inspector.resolvedPending": "尚未解析",
  "zaicode.inspector.retryOf": "重试自",
  "zaicode.inspector.delegation": "委托目标",
  "zaicode.inspector.error": "错误",
  "zaicode.inspector.result": "结果",
  "zaicode.inspector.children": "子任务",
  "zaicode.inspector.queueDepth": "队列深度",
  "zaicode.settings.productTitle": "产品",
  "zaicode.settings.productDescription":
    "ZAICODE 是构建在上游 ZAICODE 运行时之上的操作员导向多代理工作区。",
  "zaicode.settings.productName": "产品名称",
  "zaicode.settings.upstream": "上游",
  "zaicode.settings.capability.accountFreeWorkspace": "{enabled} 免账户工作区",
  "zaicode.settings.capability.agentDefinitions": "{enabled} 持久化代理定义",
  "zaicode.settings.capability.jobQueue": "{enabled} 持久化操作员任务队列",
  "zaicode.settings.capability.boundedOrchestration": "{enabled} 有界协调者委托",
  "zaicode.settings.concurrencyTitle": "队列并发",
  "zaicode.settings.concurrencyDescription":
    "每个工作区同时运行的任务上限；上限由存储状态执行，不依赖 UI 状态。",
  "zaicode.settings.templatesTitle": "代理模板",
  "zaicode.settings.templatesDescription":
    "已定义 {count} 个代理。模板只是起点，创建后可自由编辑。",
  "zaicode.settings.manageHint": "在 ZAICODE 工作区（侧边栏 -> ZAICODE）管理代理、任务与队列。",
  "zaicode.status.draft": "草稿",
  "zaicode.status.queued": "已排队",
  "zaicode.status.ready": "就绪",
  "zaicode.status.running": "运行中",
  "zaicode.status.waiting": "等待",
  "zaicode.status.blocked": "阻塞",
  "zaicode.status.completed": "已完成",
  "zaicode.status.failed": "失败",
  "zaicode.status.cancelled": "已取消",
  "zaicode.agentStatus.offline": "离线",
  "zaicode.agentStatus.idle": "空闲",
  "zaicode.agentStatus.running": "运行中",
  "zaicode.agentStatus.blocked": "阻塞",
  "zaicode.role.coordinator": "协调者",
  "zaicode.role.implementer": "实现者",
  "zaicode.role.auditor": "审计者",
  "zaicode.role.researcher": "研究员",
  "zaicode.role.custom": "自定义",
  "zaicode.subtitle": "Agent 团队：从队列领取任务，每个任务作为独立会话运行",
  "zaicode.field.pool": "模型池",
  "zaicode.field.poolHint":
    "模型池是 SAIRoute provider 暴露的 9router combo（设置 → 模型）。也可以选择其它 provider 的模型。",
  "zaicode.pool.hint.saifren": "免费 — 所有可从互联网访问的模型",
  "zaicode.pool.hint.saiopp": "付费 — 深度思考模型",
  "zaicode.pool.none": "尚未配置 provider。请在 设置 → 模型 中添加 SAIRoute provider。",
  "zaicode.pool.noRouter":
    "未找到 SAIRoute/9router provider。在 设置 → 模型 中添加后即可使用 SAIFREN / SAIOPP 池。",
  ...
  "zaicode.icons.hint":
    "每个图标占位都是一个槽位。粘贴图片 URL、data: URI 或短文本/emoji 即可实时替换；清空恢复默认。",
  "zaicode.icons.placeholder": "默认",
  "zaicode.action.close": "关闭",
  "zaicode.help.toggle": "指南",
  "zaicode.help.hide": "隐藏",
  "zaicode.help.what":
    "ZAICODE 是你的 agent 团队与 sub-agent 排：谁来做（Agent）-> 任务队列派发 -> 结果会话流式运行。",
  "zaicode.help.step1":
    "1. Agent 与模式（左）：Hunter、Tester、Cleaner、Wikier、Translator 等模式。点击模式激活并加入花名册，通过队列派发释放运行。",
  "zaicode.help.step2":
    "2. 队列（中）：新任务 -> 描述工作 -> 选择 Agent -> 添加。自动驾驶开启时会自动开始。",
  "zaicode.help.step3":
    "3. 详情（右）：点击任务查看状态、错误、结果并打开会话。并行 N 限制同时运行数量。",
  "zaicode.help.pools":
    "模型池：SAIRoute 是你的 9router provider。SAIFREN = 免费互联网模型，SAIOPP = 付费深度思考模型。",
  "zaicode.profiles.title": "Profiles",
  "zaicode.profiles.add": "新建 profile",
  "zaicode.profiles.name": "名称",
  "zaicode.profiles.icon": "图标",
  "zaicode.profiles.remove": "删除此 profile",
  "zaicode.palette.title": "Wintage 调色板",
  "zaicode.palette.crisp": "像素模式（无抗锯齿）",
  "zaicode.palette.none": "上游配色（不使用调色板）",
  "settings.subagents.description": "管理 ZAICODE Agent 运行时消费的用户级子智能体 Markdown 文件。",
  ...
  "settings.plugins.store.subtitle": "用插件为 ZAICODE 扩展技能、命令与 MCP 能力",
  ...
  "settings.plugins.import.mode.copy.description":
    "将完整插件目录复制到 ZAICODE，并注册到 plugins.dirs。外部 Agent 目录后续变更不会自动同步。",
  "settings.plugins.import.mode.symlink.description":
    "创建指向外部 Agent 插件目录的链接，并注册到 plugins.dirs。ZAICODE 会跟随来源目录后续变更，但该插件依赖来源路径持续可用。",
  "settings.plugins.import.importing": "正在导入插件到 ZAICODE",
  ...
  "settings.commands.description":
    "管理 ZAICODE Agent 的 .md 命令文件。命令可通过 /command-name 在聊天中调用。",
  ...
  "settings.commands.import.mode.copy.description":
    "将命令文件复制到 ZAICODE。外部 Agent 文件后续变更不会自动同步。",
  "settings.commands.import.mode.symlink.description":
    "创建指向外部 Agent 命令文件的链接。ZAICODE 会跟随来源文件后续变更，但该命令依赖来源路径持续可用。",
  "settings.commands.import.importing": "正在导入命令到 ZAICODE",
  ...
  "settingsSync.discovery.helper": "仅导入缺失项，不会覆盖当前 ZAICODE 中已存在的配置。",
  ...
  "onboarding.dialog.title": "欢迎使用 ZAICODE",
  "onboarding.dialog.description": "选择如何开始第一次会话。",
  "onboarding.wizard.label": "迁移向导",
  "onboarding.welcome.eyebrow": "首次启动设置",
  "onboarding.welcome.title": "欢迎使用 ZAICODE",
  "onboarding.welcome.start": "开始使用 ZAICODE",
  ...
  "onboarding.stepDescription.migration": "开始迁移并等待 ZAICODE 完成导入。",
  ...
  "onboarding.agentsFile.confirmDescription":
    "将从 {source} 复制到 {target}。\n如果目标文件已存在，ZAICODE 默认 AGENTS 配置会被覆盖。",
  ...
  "chat.placeholder.newTask": "向 ZAICODE 提问，使用 @ 添加上下文，使用 / 选择命令或能力",
  "chat.placeholder.newTaskMobile": "向 ZAICODE 提问…",
  ...
  "workflows.hub.empty.hint":
    "在对话里让 ZAICODE 设计工作流，跑通之后再让它保存到项目里。未打开的项目不会出现在这里。",
  ...
  "workflows.hub.detail.whenToUse.help": "给 ZAICODE 的路由提示：什么场景该选这个工作流。",
  ...
  "workflows.hub.detail.script.note": "脚本只读。要改脚本，在对话里让 ZAICODE 修订后另存一版。",
  ...
  "chat.error.zaicodeNoExecutionRoutes": "未配置执行路由。",
  ...
  "chat.quota.mcp.quotaExhausted": "ZAICODE MCP「{server}」今日额度已用完，明天自动恢复。",
  "chat.quota.mcp.codingPlanRequired":
    "当前无 ZAICODE MCP「{server}」额度，请登录或开通 Coding Plan 使用。",
  ...
  "feedback.submit.template.section.copyErrorHeading": "ZAICODE 报错信息",
  ...
  "offPeak.keepAwakeBanner": "ZAICODE 运行会话时保持电脑唤醒。",
  ...
  "offPeak.form.instructionsPlaceholder":
    "描述希望 ZAICODE 在后台完成的工作、预期结果和约束，例如整理本周代码改动并生成站会摘要…",
  ...
  "chat.cuaReadiness.toolsNotLoaded":
    "ZAICODE 电脑控制仍在准备中——工具尚未加载（已加载 {count} 个）。请先授予下方权限，Helper 就绪后工具会自动出现。",
  "chat.cuaReadiness.toolsPreparing":
    "ZAICODE 电脑控制仍在准备中——工具尚未加载。请先授予下方权限，Helper 就绪后工具会自动出现。",
  ...
  "cuaPermission.modal.relaunchAppButton": "重启 ZAICODE",
  "cuaPermission.modal.relaunchAppHint":
    "重启 Helper 后仍未生效？重启 ZAICODE 可彻底重载 Helper 进程。",
  ...
  "cuaPermission.tools.untrustedRuntime":
    "检测到电脑控制工具，但它们并非来自已校验的 ZAICODE 官方插件。请检查插件安装后重新验证。",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "首个会话启动时，ZAICODE 会针对该会话精确验证电脑控制工具。",
